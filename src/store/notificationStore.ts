...
export const useNotificationStore = create<NotificationState>((set, get) => ({
  ...
  sendDailyExpiryReminders: async () => {
    ...
    try {
      ...
      // ✅ FIXED EMAIL for all notifications

      const FIXED_EMAIL = "ayezinhtun9@gmail.com";
      ...
      for (const serial of expiredSerials || []) {
        ...
        if (!todayNotifications || todayNotifications.length === 0) {
          ...
          await get().sendNotificationToUser(
            ...
            FIXED_EMAIL // ✅ Send to fixed email
          ...
          if (!todayNotifications || todayNotifications.length === 0) {
            ...
            await get().sendNotificationToUser(
...

              {
                ...
                title: daysUntil <= 7 ? "License Notice: Expiring Soon" : "License Notice: Expiring Soon",
