  ...
  return (
    <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-end space-x-1">
                      ...
                      <Button
                        ...
                        onClick={async (e) => {
                          ...
                          if (
                            !window.confirm(
                              "Are you sure you want to delete this project assign?",
                            )
                          )
                            return;
                          try {
                            ...
                            toast.success(
                              "Project Assign deleted successfully",
                            );
                          } catch (error) {
      ...
      <Modal
        ...
        title={editingId ? "Edit Project Assign" : "Add New Project Assign"}
        maxWidth="lg"
      >
