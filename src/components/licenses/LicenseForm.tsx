...
export const LicenseForm: React.FC<LicenseFormProps> = ({
  ...
  const computeNotifyDate = (endDate?: string, notifyBeforeDays?: number | null) => {
                ...
                <div key={idx} className="p-4 bg-white rounded border">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <Input
                      ...
                      value={computeNotifyDate(s.end_date, s.notify_before_days)}
                      ...
                      onChange={(notifyOn) => {
                        ...
                        if (s.end_date && chosen && parseISO(chosen) > parseISO(s.end_date)) {

                          chosen = s.end_date; // clamp to end_date if user picks later date

                        }

                        const offset = computeNotifyBeforeDays(s.end_date, chosen);
