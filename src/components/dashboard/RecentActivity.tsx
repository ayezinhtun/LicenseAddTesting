  ...
  const mockActivities = [
    {
      ...
      description:
        "Microsoft Office 365 Enterprise E3 license added for Corporate Infrastructure project",
      user: "Admin User",
    ...
    },
    {
      ...
      description:
        "Adobe Creative Cloud license renewed for Marketing & Design project",
      user: "John Manager",
    ...
    },
    {
      ...
      description:
        "Slack Pro license details updated - increased user count to 80",
      user: "Sarah Analyst",
